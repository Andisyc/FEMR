...
CURRICULUM_PERTURBATION_BASES="${CURRICULUM_PERTURBATION_BASES:-planar,yaw,global_z,local_rp}"
...
CMD=(
  ...
  --frontres_segment_cache_curriculum_perturbation_bases "${CURRICULUM_PERTURBATION_BASES}"
