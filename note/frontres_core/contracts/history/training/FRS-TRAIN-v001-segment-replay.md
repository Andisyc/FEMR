contract_id: FRS-TRAIN-v001
status: superseded
effective_date: 2026-07-13
updated_date: 2026-07-13
supersedes: none
superseded_by: FRS-TRAIN-v002
...
training. Method semantics remain in `../method/FRS-METHOD-v010-segment-replay.md`.
...
The current RP-only live Segment score is a known implementation mismatch. It
must remain visible until the new gain is connected; documentation must not
describe it as the accepted reward design.
