...
| G5-S4-S2 command/artifact/threshold preflight | formal train and quality routes | S0 T-artifact/T-command/T-telemetry/T-threshold/T-stop | completed for route launch; quality gate superseded by Q1--Q6 | `E-FI-55`, `E-FI-58`; corrected train and quality commands completed, but candidate quality thresholds cannot be authoritative before the no-op/Physics/state oracles close |
| G5-S4-S4 bounded training/policy-quality | formal v015 train and held-out quality routes | S4 T-train/T-action/T-gain/T-harm/T-checkpoint/T-fresh-reload/T-report | runtime route completed; quality verdict blocked | `E-FI-55`, `E-FI-58`; exact-one train/save and atomic 16-item quality report completed; action is non-collapsed, but zero no-op, Physics evidence and full dynamic-state identity are not established |
| G5-Q0 quality-gap plan rebase | v015 plan/checklist/canvas/evidence/Quality Audit Atlas | S0 T-plan/T-status/T-dependency/T-legacy-isolation | completed | `E-FI-58`; preserves G0--G4 and G5-S1--S4-S1E while setting `evaluation-authority blocked / policy efficacy unconfirmed`; old v002/Q-E evidence is historical/incompatible |
| G5-Q1 full dynamic-state identity | active v015 held-out route/reset boundary | S1/S2/S4 T-state-schema/T-role/T-permutation/T-route-equality/T-reset-repeat/T-no-feedback/T-live-identity | partial: S1/S2 completed; S4 user-gated | `E-FI-59`; B=8 read-only root/joint/env/episode/command/perturber/RNG/local-scenario hashes bind every route and mismatch blocks atomic output; one bounded live identity sentinel remains |
| G5-Q2 zero-action no-op oracle | active v015 held-out one-action-K owner | S1/S2/S4 T-zero-action/T-no-op/T-tolerance/T-metamorphic/T-live-no-op | blocked by Q1 | Repair and Noisy must be equal within predeclared tolerance under zero action; unexplained nonzero Gain blocks Q3 |
| G5-Q3 Physics survival/ZMP/contact evidence | unique v003 Gain evidence owner and held-out connector | S1/S2/S4 T-survival/T-zmp/T-contact/T-sign/T-consumer/T-legacy-reject/T-live-variation | blocked by Q2 | Reject absent, constant, silently zero-filled, unmatched or diagnostic-recomputed physical components |
| G5-Q4 matched zero/HSL/policy rerun | fixed manifest / strict routes / atomic report | S4 T-state-identity/T-no-op/T-physics/T-route/T-report/T-zero-write | blocked by Q3 | Rerun only after Q1--Q3 close; stop on any unmatched identity or failed oracle |
| G5-Q5 Gain-to-advantage-to-update causality | v003 return/storage/grouped PPO/update owners | S1/S2/S4 T-row-identity/T-sign/T-mass/T-covariance/T-controlled-update/T-live-trace | blocked by Q4 | Stop on sign flip, row/mass loss, mixed credit or update not attributable to sealed rows |
| G5-Q6 checkpoint trajectory/long-training admission | strict v015 checkpoint and fixed-manifest quality owners | S3/S4 T-checkpoint-axis/T-fresh/T-atomic-series/T-action/T-gain/T-harm/T-admission | blocked by Q5 | No long training before Q1--Q5; stop on identity drift, unmatched reports or unexplained regression |
