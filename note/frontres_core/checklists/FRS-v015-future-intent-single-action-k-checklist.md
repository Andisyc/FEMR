...
| G5-S4-S2 command/artifact/threshold preflight | formal train and quality routes | S0 T-artifact/T-command/T-telemetry/T-threshold/T-stop | ready, user-gated | read-only server preflight; artifact existence and thresholds require explicit user confirmation |
| G5-S4-S4 bounded training/policy-quality | formal v015 train and held-out quality routes | S4 T-train/T-action/T-gain/T-harm/T-checkpoint/T-fresh-reload/T-report | blocked by S2 and user confirmation | one transaction/update/save plus fresh held-out evaluation; route-only success remains insufficient |
