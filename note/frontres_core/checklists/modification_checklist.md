...
| Q2-D Stage 3 over-amplitude correction | canonical Gain -> returns/advantages -> controlled PPO mean update on fixed Q2 evidence | S1/S2 `T-sweep/T-sign/T-credit/T-gradient/T-direction/T-heldout` | planned; blocked on bounded offline implementation | Q-E19: HSL over-amplitude is an initial defect only; generic PPO contracts do not prove correction on the failed real samples |
...
| Q2-D3 Real failed-sample causality | scaled-HSL physical Gain + real Stage 3 batch credit/update | S4 `T-live/T-gain/T-credit/T-update/T-identity` | pending user approval | Only remaining facts: physical Gain-preferred scale and real sampled-action/advantage covariance |
