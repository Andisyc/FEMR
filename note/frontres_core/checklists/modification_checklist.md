...
| Gain/returns | S4 `T-value/T-forward` | single-capture identity and policy-row diagnostic slice live-confirmed by E67; mixed-K population, actor quality, and resume remain open | `AUDIT-GAIN-01`, `AUDIT-RETURN-01`, E62/E63/E64/E66/E67: shared capture route, transaction/batch identity, policy-row Gain steps, local K-normalized survival trace, canonical gain_total forwarding, returns, and advantages |
