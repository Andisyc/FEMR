...
| Method v016 active semantics | v015 replay authority plus scalar Intent Critic and independent Contact/phase-ZMP/survival actor constraints | S0 `T-design/T-identity/T-boundary` | P1 contract-active; P2 source implementation not started | `contracts/active/method/FRS-METHOD-v016-physics-constrained-intent-replay.md` and v015 migration checklist |
