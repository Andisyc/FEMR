...
| Gain/returns | S4 `T-value/T-forward` | identity and policy-row diagnostic slice offline-confirmed; formal numeric consumer comparison open; actor quality deferred to post-training | `AUDIT-GAIN-01`, `AUDIT-RETURN-01`, E62/E63/E64/E66: shared capture route, transaction/batch identity, policy-row Gain steps, local K-normalized survival trace, canonical gain_total forwarding, returns, and advantages |
