...
| PHASE-B-01 | live S4 | official train entry emits active contract/HSL-v2/K8-M2/offset `(1,2)` identity with no legacy route | instrumented; offline contract passed; live pending | AUDIT-B01 / Runtime Audit Atlas R01 / E-FI-121 |
| PHASE-B-02 | live S4 | sampler emits two sealed Segments x exact M=2 with four immutable policy rows and no reset resampling | instrumented; offline contract passed; live pending | AUDIT-B02 / R02 / E-FI-121 |
| PHASE-B-03 | live S4 | real reset/command/observation route proves B=8 roles and `870+58 -> 928 -> 158/770` with Noisy provenance | instrumented; offline contract passed; live pending | AUDIT-B03 / R03 / E-FI-121 |
...
| PHASE-B-05 | live S4 | Clean=2, Noisy=2 and Repair=4 feed complete v007 `G_I/G_P/P_N/P_R/lambda/cost/G_total` evidence | instrumented; offline contract passed; live pending | AUDIT-B05 / R05 / E-FI-121 |
| PHASE-B-06 | live S4 | storage writes four policy rows, not K-expanded rows; return equals G_total and identity remains sealed | instrumented; offline contract passed; live pending | AUDIT-B06 / R06 / E-FI-121 |
