...
| S4-QUALITY | live | real Gain/Contact/ZMP/survival/action facts are finite or semantic N/A | evaluator ready offline after full read-only dataset/reset-support edge closure; real evaluation pending | E-FI-129 closes the coordinate blocker; E-FI-130 supplies strict checkpoint-v9 K16/M3 EVAL-v004 dispatch; E-FI-131 isolates policy-quality from the legacy live-runner boundary; E-FI-132 installs cache-backed dataset/reset support without a sampler and revalidates the complete deterministic route; E-FI-128 quality rows remain invalid |
