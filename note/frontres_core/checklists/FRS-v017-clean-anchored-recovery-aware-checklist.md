...
| PHASE-B-02 | live S4 | sampler emits two sealed Segments x exact M=2 with four immutable policy rows and no reset resampling | reset/observation/action/one-action-K reached live; Repair row alignment and grouped-batch dependency repaired offline; sentinel still pending | AUDIT-B02 / R02 / E-FI-123 / E-FI-124 |
