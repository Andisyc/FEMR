...
| PHASE-B-02 | live S4 | sampler emits two sealed Segments x exact M=2 with four immutable policy rows and no reset resampling | first run stopped before sentinel; reset lifecycle repaired offline; live rerun pending | AUDIT-B02 / R02 / E-FI-122 |
