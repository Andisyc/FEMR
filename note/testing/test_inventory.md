...
| `source/rsl_rl/rsl_rl/tests/frontres_segment_algorithm_contract.py` | S1/S2 | MAIN-46/47, M2C-16/18 | `python source/rsl_rl/rsl_rl/tests/frontres_segment_algorithm_contract.py` | contract-confirmed | Segment algorithm update contract, including positive-advantage gradient direction toward stored 6D Delta SE actions and old-stat distribution KL diagnostics. |
