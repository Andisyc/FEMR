...
| `source/rsl_rl/rsl_rl/tests/frontres_segment_live_single_update_contract.py` | S2 | MAIN-39, MAIN-46 | `python source/rsl_rl/rsl_rl/tests/frontres_segment_live_single_update_contract.py` | connectivity-confirmed | Live single-update contract, including old-stat pre KL, MOSAIC-style pre-step adaptive LR before optimizer.step, post-update trust-region KL reporting, post-ratio max diagnostics, optimizer parameter delta, and adaptive trust-region rollback of rejected post-KL steps. |
