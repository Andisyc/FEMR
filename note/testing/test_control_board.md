...
| MAIN-19 | `front_residual_actor_critic.py` | Algorithm / loss / optimizer | S1, S2 | T-shape, T-order, T-mask, T-grad, T-connect | `frontres_task_space_proposal_only_contract.py`; HSL policy tests likely | contract-confirmed | covered | Live policy quality not claimed. |
...
| MAIN-32 | `frontres_checkpointing.py` | Checkpoint / resume / export / play | S3 | T-persist, T-order, T-diff | checkpoint contracts | persistence-confirmed | covered | Export/play sink separate. |
...
| MAIN-37 | `frontres_segment_live_sampler.py` | Sampler / curriculum / priority | S1, S2, S4 when live sampling changes | T-dist, T-role, T-connect, T-live | live sampler contract; pseudo suite | contract-confirmed | covered | None known. |
| MAIN-38 | `frontres_segment_live_training.py` | Runner / orchestration | S2, S4 | T-connect, T-oracle, T-live | pseudo suite; live sentinel | runtime-confirmed | covered-but-live-gap | Expensive full training not claimed. |
...
| MAIN-40 | `frontres_segment_sequence_eval.py` | Reward / metric / evaluator | S2, S4 | T-role, T-oracle, T-meta, T-diff, T-live | sequence eval contract; live sentinel | connectivity-confirmed | covered-but-live-gap | Real long sequence eval is S4. |
...
| MAIN-48 | `frontres_segment_checkpointing.py` | Checkpoint / resume / export / play | S3 | T-persist, T-order, T-diff | checkpoint/resume contracts | persistence-confirmed | covered | None known. |
