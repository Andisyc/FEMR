...
- `runtime/04_frontres_design_inspector.data.json`: interactive Design Inspector: ten compact parent design points highlight where their fine-grained decisions change one shared Stage-3 Transaction spine. Repair Gain, Actor & Critic Warmup and Future Motion Context project the confirmed v018/v016/v006 state-value change; offline implementation and checkpoint-v11 Module Test evidence are complete, while Phase A/B remain gated.
