...
"449D Critic",
"当前 M4 算术均值提供 Critic target",
"第一笔 committed Transaction 起 Actor 与 Critic 就同时更新",
"进入 Joint Optimize 后 Critic 仍持续更新",
"每笔 Transaction 包含八个不同 sealed state",
]) {
