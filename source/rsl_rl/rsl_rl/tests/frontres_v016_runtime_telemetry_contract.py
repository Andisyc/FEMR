#!/usr/bin/env python3
"""Deterministic TEST-18 final-consumer contracts for TRAIN-v016 telemetry."""
...
def main() -> None:
    ...
    assert telemetry["optimization_contract_id"] == "FRS-PPO-v006"
    assert telemetry["training_contract_id"] == "FRS-TRAIN-v016"
    assert telemetry["checkpoint_format"] == "frontres-v017-checkpoint-v11"
    ...
    assert telemetry["critic_target_id"] == "segment-exact-m-mean-v1"
