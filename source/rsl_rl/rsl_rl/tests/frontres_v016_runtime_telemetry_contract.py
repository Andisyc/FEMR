...
def main() -> None:
    ...
    assert telemetry["method_contract_id"] == "FRS-METHOD-v025"
    assert telemetry["optimization_contract_id"] == "FRS-PPO-v012"
    assert telemetry["training_contract_id"] == "FRS-TRAIN-v024"
    assert telemetry["checkpoint_format"] == "frontres-v024-checkpoint-v19"
    ...
    assert telemetry["critic_target_id"] == "scenario-current-exact-m4-mean-symlog-v1"
