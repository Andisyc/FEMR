...
def main() -> None:
    ...
    assert "FRS-PPO-v008 rejects retired Stage-3 single_update/update_loop modes" in train
    ...
    assert '" --frontres_segment_cache_dir ${CACHE_DIR} "' in stage3
    assert '" --frontres_segment_shard_cache_size ${SHARD_CACHE_SIZE} "' in stage3
    assert 'FRS-PPO-v008 rejects retired optimizer-writing Stage 3 mode' in stage3
