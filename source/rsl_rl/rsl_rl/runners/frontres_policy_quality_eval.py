...
class FrontRESV018PolicyQualityEvalRequest:
    """Strict HSL-v2 plus checkpoint-v16 K8/K16 M4 identity for EVAL-v004."""
...
def run_frontres_v018_policy_quality_heldout_eval(
    ...
    *,
    ...
    # B1: 冻结训练状态并安装 tested checkpoint-v16, 产出 inference-only policy owner.
...
def run_frontres_policy_quality_eval(
    ...
    *,
    ...
    """Run the active EVAL-v004 checkpoint-v16 held-out evaluator."""

    # B1: 验证 formal runner 并构造 strict v018 request, 产出 checkpoint-v16 evaluation identity.
    if not bool(getattr(getattr(runner, "alg", None), "frontres_formal_transaction_enabled", False)):
        raise RuntimeError(
