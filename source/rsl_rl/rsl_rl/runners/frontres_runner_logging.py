...
def log_runner(self, locs: dict, width: int = 80, pad: int = 35):
    ...
    _to_frontres  = {
        ...
        "structured_joint_rl_repairable_loss",
        "structured_joint_rl_boundary_loss",
        "structured_joint_rl_repairable_authority_mean",
        "structured_joint_rl_boundary_authority_mean",
        ...
        "structured_joint_rl_rho_action_minus_mean_abs",
        "structured_joint_rl_rho_action_minus_mean_rho_abs",
